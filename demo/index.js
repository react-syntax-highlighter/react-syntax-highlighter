...
function createElement({ node, style, useInlineStyles, key }) {
  ...
  `;
    this.state = {
      ...
      style: require('../dist/styles/lowlight/tomorrow-night-eighties').default,
    ...
    return (
      <div>
        ...
        <select 
          ...
          onChange={(e) => this.setState({style: require(`../dist/styles/lowlight/${e.target.value}`).default, selected: e.target.value})}
        >
