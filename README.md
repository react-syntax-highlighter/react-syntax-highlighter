...
- `renderer` - an optional custom renderer for rendering lines of code. See <a href="https://github.com/conorhastings/react-syntax-highlighter-virtualized-renderer/blob/bb7f25bfac5f3aff0f0d4b4b1ac9adf3b4673285/src/index.jsx">here</a> for an example.
