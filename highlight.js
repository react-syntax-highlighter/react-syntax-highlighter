...
exports.default = function(defaultAstGenerator, defaultStyle) {
  return function SyntaxHighlighter(_ref6) {
    var language = _ref6.language,
      ...
      codeTagProps =
        _ref6$codeTagProps === undefined
          ? { style: style['code[class*="language-"]'] }
          : _ref6$codeTagProps,
      _ref6$useInlineStyles = _ref6.useInlineStyles,
      useInlineStyles =
        _ref6$useInlineStyles === undefined ? true : _ref6$useInlineStyles,
      _ref6$showLineNumbers = _ref6.showLineNumbers,
      showLineNumbers =
        _ref6$showLineNumbers === undefined ? false : _ref6$showLineNumbers,
      _ref6$startingLineNum = _ref6.startingLineNumber,
      startingLineNumber =
        _ref6$startingLineNum === undefined ? 1 : _ref6$startingLineNum,
      ...
      code =
        _ref6$code === undefined
          ? Array.isArray(children)
            ? children[0]
            : children
          : _ref6$code,
      astGenerator = _ref6.astGenerator,
      rest = (0, _objectWithoutProperties3.default)(_ref6, [
        'language',
        'children',
        'style',
        'customStyle',
    ...
    var lineNumbers = showLineNumbers
      ? _react2.default.createElement(LineNumbers, {
    ...
    var preProps = useInlineStyles
      ...
      : (0, _assign2.default)({}, rest, { className: 'hljs' });
    ...
    if (!astGenerator) {
      return _react2.default.createElement(
        ...
        preProps,
        lineNumbers,
        _react2.default.createElement(CodeTag, codeTagProps, code)
      );
    }
...
function LineNumbers(_ref2) {
  var codeString = _ref2.codeString,
    ...
    containerStyle =
      _ref2$containerStyle === undefined
